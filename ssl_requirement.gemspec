Gem::Specification.new do |s|
  ...
  s.authors = ['RailsJedi', 'David Heinemeier Hansson', 'jcnetdev', 'bcurren', 'bmpercy','corny']
  s.email = 'github.corny@digineo.de'
  s.homepage = 'http://github.com/corny/ssl_requirement'
